<svelte:head><meta charset="utf-8" />
    ...
    <!-- Bootstrap Css -->
    <link href="https://themesbrand.com/velzon/html/saas/assets/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <!-- Icons Css -->
    ...
    <script src="./js/pricing.init.js"></script>
                        ...
                        <div class="col-xxl-3 col-lg-6">
                            <div class="card pricing-box">
                                <div class="card-body bg-light m-2 p-4">
                                    ...
                                    <div class="mt-3 pt-2">
                                        <a href="#;" class="btn btn-danger disabled w-100">Your Current
                                            Plan</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xxl-3 col-lg-6">
                            <div class="card pricing-box">
                                <div class="card-body bg-light m-2 p-4">
                                    ...
                                    <div class="mt-3 pt-2">
                                        <a href="#;" class="btn btn-info w-100">Change Plan</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="card pricing-box">
                                        <div class="card-body p-4 m-2">
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-4">
                                                    <a href="#;" class="btn btn-soft-success w-100 waves-effect waves-light">Sign
                                                        up free</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card pricing-box ribbon-box right">
                                        <div class="card-body p-4 m-2">
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-4">
                                                    <a href="#;" class="btn btn-success w-100 waves-effect waves-light">Get
                                                        started</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card pricing-box">
                                        <div class="card-body p-4 m-2">
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-4">
                                                    <a href="#;" class="btn btn-soft-success w-100 waves-effect waves-light">Get
                                                        started</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="card-body h-100">
                                            ...
                                            <div class="text-center plan-btn mt-2">
                                                <a href="#;" class="btn btn-success w-sm waves-effect waves-light">Sign up</a>
                                            </div>
                                        </div>
                                    </div>
                                    <!--end col-->
