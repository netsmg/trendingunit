					...
					<div class="details">
						<div class="details__head">
							...
							<div class="details__wrap">
								<h1 class="details__title">FlixHub – Digital marketplace HTML Template</h1>

								<ul class="details__list">
									<li><span>Category:</span> <a href="#">HTML Template</a></li>
									<li><span>Created by:</span> <a href="#">Dmitry Vetrov</a></li>
									<li><span>Released:</span> March 17, 2020</li>
									<li><span>Last update:</span> April 19, 2020</li>
						...
						<div class="details__gallery">
							<div class="details__carousel owl-carousel" id="details__carousel">
								<a href="img/details/1-1.jpg" >
									<img src="https://flixhub.volkovdesign.com/img/details/1.jpg" alt="">
								</a>

								<a href="img/details/2-2.jpg" >
									<img src="https://flixhub.volkovdesign.com/img/details/2.jpg" alt="">
								</a>

								<a href="img/details/3-3.jpg" >
									<img src="https://flixhub.volkovdesign.com/img/details/3.jpg" alt="">
								</a>

								<a href="img/details/4-4.jpg" >
									<img src="https://flixhub.volkovdesign.com/img/details/4.jpg" alt="">
								</a>

								<a href="img/details/5-5.jpg" >
									<img src="https://flixhub.volkovdesign.com/img/details/5.jpg" alt="">
								</a>

								<a href="img/details/6-6.jpg" >
									<img src="https://flixhub.volkovdesign.com/img/details/6.jpg" alt="">
								</a>
							</div>
								...
								<div class="col-12 col-xl-4 order-xl-2">
									...
									<div class="requirements">
										...
										<ul class="requirements__list">
											...
											<li><span>Last update:</span> April 19, 2020</li>
											<li><span>Version:</span> 1.1</li>
											<li><span>Tags:</span> <a href="#">digital</a>, <a href="#">distribution</a>, <a href="#">esports</a>, <a href="#">gaming</a>, <a href="#">market</a>, <a href="#">marketplace</a>, <a href="#">store</a></li>
										</ul>
									</div>
									<!-- end requirements -->
										...
										<ul class="comments__list">
											<li class="comments__item">
												<div class="comments__autor">
													<img class="comments__avatar" src="https://flixhub.volkovdesign.com/img/user.svg" alt="">
		...
		<div class="owl-carousel section__carousel section__carousel--catalog" id="carousel1">
			...
			<div class="card">
				<a href="/" class="card__cover">
					...
					<span class="card__rate"><svg xmlns='http://www.w3.org/2000/svg' width='512' height='512' viewBox='0 0 512 512'><path d='M394,480a16,16,0,0,1-9.39-3L256,383.76,127.39,477a16,16,0,0,1-24.55-18.08L153,310.35,23,221.2A16,16,0,0,1,32,192H192.38l48.4-148.95a16,16,0,0,1,30.44,0l48.4,149H480a16,16,0,0,1,9.05,29.2L359,310.35l50.13,148.53A16,16,0,0,1,394,480Z'/></svg> 4.0</span>
				</a>
